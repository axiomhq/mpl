...
import init, * as mpl from "@axiomhq/mpl";
...
const DUMMY_DATASETS: Record<string, Record<string, string[]>> = {
  ...
  "axiom-dev.metrics": {
    "axiom_http_requests_total":                        ["method", "path", "code", "container", "status"],
    "axiomdb_transport_request_duration_seconds_bucket": ["status", "handler", "le"],
    "alertmanager_alerts":                              ["service", "namespace"],
  },
  // Used by: as, slo-ingest-rate examples
  "test-with-minus.com": {
    "axiomdb_transport_ingest_pressure": ["time_window", "service"],
  },
  // Used by: most examples (slo, histogram, enrich, map-*, sum_rate, etc.)
  "test": {
    "axiom_http_requests_total":                        ["method", "path", "code", "container"],
    "axiom_http_request_duration_seconds_bucket":       ["method", "path", "code", "le", "handler"],
    "axiom_http_request_duration_seconds_count":        ["method", "path", "code", "container"],
